...
public class RequestMetadata {
     ...
     * https://cloud.google.com/compute/docs/vpc/ for more information. This is a scheme-less
     * URI full resource name. For example:
     ...
     * accordingly. For example: +   `google-api-python-client/1.4.0`:     The request was made
     * by the Google API client for Python. +   `Cloud SDK Command Line Tool apitools-client/1.0
     * gcloud/0.9.62`:     The request was made by the Google Cloud SDK CLI (gcloud). +
     * `AppEngine-Google; (+http://code.google.com/appengine; appid: s~my-project`:     The
