...
public class ProtoPayload {
     ...
     */
    public List<AuthorizationInfo> getAuthorizationInfo() { return authorizationInfo; }
    public void setAuthorizationInfo(List<AuthorizationInfo> value) { this.authorizationInfo = value; }
    ...
    /**
     * The name of the service method or operation. For API calls, this should be the name of
     * the API method. For example,     "google.datastore.v1.Datastore.RunQuery"
     ...
     * URI, not including the API service name. For example:     "shelves/SHELF_ID/books"
