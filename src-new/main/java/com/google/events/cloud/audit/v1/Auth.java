...
public class Auth {
    ...
    public void setAccessLevels(List<String> value) { this.accessLevels = value; }
     ...
     * include one or more of the following pieces of information: *  The services intended to
     * receive the credential such as    ["pubsub.googleapis.com", "storage.googleapis.com"] *
     * A set of service-based scopes. For example,
     * ["https://www.googleapis.com/auth/cloud-platform"] *  The client id of an app, such as
     * the Firebase project id for JWTs    from Firebase Auth. Consult the documentation for the
     * credential issuer to determine the information provided.
     */
    public List<String> getAudiences() { return audiences; }
    public void setAudiences(List<String> value) { this.audiences = value; }

    /**
     * Structured claims presented with the credential. JWTs include `{key: value}` pairs for
     * standard and private claims. The following is a subset of the standard required and
     * optional claims that would typically be presented for a Google-based JWT:    {'iss':
     * 'accounts.google.com',     'sub': '113289723416554971153',     'aud': ['123456789012',
     * 'pubsub.googleapis.com'],     'azp': '123456789012.apps.googleusercontent.com',
     * 'email': 'jsmith@example.com',     'iat': 1353601026,     'exp': 1353604926} SAML
     * assertions are similarly specified, but with an identity provider dependent structure.
     */
