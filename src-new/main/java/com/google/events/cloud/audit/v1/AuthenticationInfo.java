...
public class AuthenticationInfo {
     ...
     * principal) making the request. For third party identity callers, the `principal_subject`
     ...
     */
    public List<ServiceAccountDelegationInfo> getServiceAccountDelegationInfo() { return serviceAccountDelegationInfo; }
    public void setServiceAccountDelegationInfo(List<ServiceAccountDelegationInfo> value) { this.serviceAccountDelegationInfo = value; }
