...
public class ResourceAttributesClass {
     ...
     * name and a URI are: *   Resource name is a logical identifier, independent of network
     * protocol and API version. For example,
     * `//pubsub.googleapis.com/projects/123/topics/news-feed`. *   URI often includes protocol
     * and version information, so it can     be used directly by applications. For example,
     ...
     * define their resources differently. For Google APIs, the type format must be
     * "{service}/{kind}".
     */
