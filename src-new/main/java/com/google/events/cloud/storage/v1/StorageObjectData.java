...
public class StorageObjectData {
     ...
     * compose operations. Attempting to set this field will result in an error.
     */
     ...
     * [https://tools.ietf.org/html/rfc7231#section-3.1.1.5][RFC 7231 §3.1.1.5]. If an object is
     * stored without a Content-Type, it is served as `application/octet-stream`.
     */
     ...
     * [https://cloud.google.com/storage/docs/hashes-etags#_JSONAPI][Hashes and ETags: Best
     * Practices].
     */
    ...
    /**
     * The content generation of this object. Used for object versioning. Attempting to set this
     ...
     * [https://tools.ietf.org/html/rfc4648#section-4][RFC 4648 §4]. For more information about
     * using the MD5 hash, see
     * [https://cloud.google.com/storage/docs/hashes-etags#_JSONAPI][Hashes and ETags: Best
     * Practices].
     */
    ...
    /**
     * The deletion time of the object. Will be returned if and only if this version of the
