...
public class Artifacts {
     ...
     * images will be pushed using the builder service account's credentials. The digests of the
     * pushed images will be stored in the Build resource's results field. If any of the images
