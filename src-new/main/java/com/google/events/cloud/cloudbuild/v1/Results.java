...
public class Results {
     ...
     */
    public List<String> getBuildStepImages() { return buildStepImages; }
    public void setBuildStepImages(List<String> value) { this.buildStepImages = value; }

    /**
     * List of build step outputs, produced by builder images, in the order corresponding to
     * build step indices. [Cloud
     * Builders](https://cloud.google.com/cloud-build/docs/cloud-builders) can produce this
     * output by writing to `$BUILDER_OUTPUT/output`. Only the first 4KB of data is stored.
     */
    public List<String> getBuildStepOutputs() { return buildStepOutputs; }
    public void setBuildStepOutputs(List<String> value) { this.buildStepOutputs = value; }

    /**
     * Container images that were built as a part of the build.
     */
    public List<BuiltImage> getImages() { return images; }
    public void setImages(List<BuiltImage> value) { this.images = value; }
