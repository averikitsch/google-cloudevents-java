...
public class Objects {
     ...
     * Requirements](https://cloud.google.com/storage/docs/bucket-naming#requirements)). Files
     * in the workspace matching any path pattern will be uploaded to Cloud Storage with this
    ...
    public void setPaths(List<String> value) { this.paths = value; }
