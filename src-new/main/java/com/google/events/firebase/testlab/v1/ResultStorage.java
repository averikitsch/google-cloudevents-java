...
public class ResultStorage {
    ...
    /**
     * Location in Google Cloud Storage where test results are written to. In the form
     ...
     * `projects/{project_id}/histories/{history_id}/executions/{execution_id}`. Optional, can
     * be omitted in erroneous test states. See
     * https://firebase.google.com/docs/test-lab/reference/toolresults/rest for more information.
     */
     ...
     * `projects/{project_id}/histories/{history_id}`. See
     * https://firebase.google.com/docs/test-lab/reference/toolresults/rest for more information.
     */
