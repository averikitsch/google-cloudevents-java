...
public class DeviceInfo {
    ...
    /**
     * Vendor specific device identifier. This is IDFV on iOS. Not used for Android. Example:
    ...
    /**
     * The device's Limit Ad Tracking setting. When true, we cannot use device_id for
     * remarketing, demographics or influencing ads serving behaviour. However, we can use
     * device_id for conversion tracking and campaign attribution.
     */
    ...
    /**
     * The type of the resettable_device_id is always IDFA on iOS and AdId on Android. Example:
