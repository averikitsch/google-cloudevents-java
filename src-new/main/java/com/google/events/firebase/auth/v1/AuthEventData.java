...
public class AuthEventData {
    ...
    /**
     * User's custom claims, typically used to define user roles and propagated to an
     ...
     */
    public List<UserInfo> getProviderData() { return providerData; }
    public void setProviderData(List<UserInfo> value) { this.providerData = value; }
