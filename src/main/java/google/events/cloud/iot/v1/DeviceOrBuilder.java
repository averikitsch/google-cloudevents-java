...
public interface DeviceOrBuilder extends
   ...
   */
  java.util.List<google.events.cloud.iot.v1.DeviceCredential> 
      getCredentialsList();
  /**
   * <pre>
   * The credentials used to authenticate this device. To allow credential
   ...
   * <code>repeated .google.events.cloud.iot.v1.DeviceCredential credentials = 12;</code>
   */
  google.events.cloud.iot.v1.DeviceCredential getCredentials(int index);
  /**
   * <pre>
   * The credentials used to authenticate this device. To allow credential
   * rotation without interruption, multiple device credentials can be bound to
   ...
   * <code>repeated .google.events.cloud.iot.v1.DeviceCredential credentials = 12;</code>
   */
  java.util.List<? extends google.events.cloud.iot.v1.DeviceCredentialOrBuilder> 
   ...
   * <code>repeated .google.events.cloud.iot.v1.DeviceCredential credentials = 12;</code>
   */
  google.events.cloud.iot.v1.DeviceCredentialOrBuilder getCredentialsOrBuilder(
      int index);
   ...
   * @return The config.
   */
  google.events.cloud.iot.v1.DeviceConfig getConfig();
  /**
   * <pre>
   * The most recent device configuration, which is eventually sent from
   * Cloud IoT Core to the device. If not present on creation, the
   ...
   * <code>.google.events.cloud.iot.v1.DeviceConfig config = 13;</code>
   */
  google.events.cloud.iot.v1.DeviceConfigOrBuilder getConfigOrBuilder();
   ...
   * @return The state.
   */
  google.events.cloud.iot.v1.DeviceState getState();
  /**
   * <pre>
   * [Output only] The state most recently received from the device. If no state
   * has been reported, this field is not present.
   ...
   * <code>.google.events.cloud.iot.v1.DeviceState state = 16;</code>
   */
  google.events.cloud.iot.v1.DeviceStateOrBuilder getStateOrBuilder();
...
java.lang.String defaultValue);
   ...
   */
  google.events.cloud.iot.v1.GatewayConfig getGatewayConfig();
  /**
   * <pre>
   * Gateway-related configuration and state.
   * </pre>
   ...
   * <code>.google.events.cloud.iot.v1.GatewayConfig gateway_config = 24;</code>
   */
  google.events.cloud.iot.v1.GatewayConfigOrBuilder getGatewayConfigOrBuilder();
}
