...
public interface DeviceCredentialOrBuilder extends
   ...
   */
  google.events.cloud.iot.v1.PublicKeyCredential getPublicKey();
  /**
   * <pre>
   * A public key used to verify the signature of JSON Web Tokens (JWTs).
   * When adding a new device credential, either via device creation or via
   ...
   * <code>.google.events.cloud.iot.v1.PublicKeyCredential public_key = 2;</code>
   */
  google.events.cloud.iot.v1.PublicKeyCredentialOrBuilder getPublicKeyOrBuilder();
  ...
  public google.events.cloud.iot.v1.DeviceCredential.CredentialCase getCredentialCase();
}
