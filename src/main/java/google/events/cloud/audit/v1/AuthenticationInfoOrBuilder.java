...
public interface AuthenticationInfoOrBuilder extends
   ...
   */
  java.util.List<google.events.cloud.audit.v1.ServiceAccountDelegationInfo> 
   ...
   * <code>repeated .google.events.cloud.audit.v1.ServiceAccountDelegationInfo service_account_delegation_info = 6;</code>
   */
  google.events.cloud.audit.v1.ServiceAccountDelegationInfo getServiceAccountDelegationInfo(int index);
  /**
   * <pre>
   * Identity delegation history of an authenticated service account that makes
   * the request. It contains information on the real authorities that try to
   ...
   * <code>repeated .google.events.cloud.audit.v1.ServiceAccountDelegationInfo service_account_delegation_info = 6;</code>
   */
  java.util.List<? extends google.events.cloud.audit.v1.ServiceAccountDelegationInfoOrBuilder> 
   ...
   * <code>repeated .google.events.cloud.audit.v1.ServiceAccountDelegationInfo service_account_delegation_info = 6;</code>
   */
  google.events.cloud.audit.v1.ServiceAccountDelegationInfoOrBuilder getServiceAccountDelegationInfoOrBuilder(
      int index);
