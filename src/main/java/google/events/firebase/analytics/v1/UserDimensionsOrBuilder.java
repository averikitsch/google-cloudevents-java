...
public interface UserDimensionsOrBuilder extends
  ...
  java.util.Map<java.lang.String, google.events.firebase.analytics.v1.UserPropertyValue>
  getUserProperties();
  /**
   * <pre>
   * A repeated record of user properties set with the setUserProperty API.
  ...
  /* nullable */
google.events.firebase.analytics.v1.UserPropertyValue getUserPropertiesOrDefault(
      java.lang.String key,
      /* nullable */
google.events.firebase.analytics.v1.UserPropertyValue defaultValue);
  ...
  google.events.firebase.analytics.v1.UserPropertyValue getUserPropertiesOrThrow(
      java.lang.String key);
   ...
   */
  google.events.firebase.analytics.v1.DeviceInfo getDeviceInfo();
  /**
   * <pre>
   * Device information.
   * </pre>
   ...
   * <code>.google.events.firebase.analytics.v1.DeviceInfo device_info = 4;</code>
   */
  google.events.firebase.analytics.v1.DeviceInfoOrBuilder getDeviceInfoOrBuilder();
   ...
   * @return The geoInfo.
   */
  google.events.firebase.analytics.v1.GeoInfo getGeoInfo();
  /**
   * <pre>
   * User's geographic information.
   * </pre>
   ...
   * <code>.google.events.firebase.analytics.v1.GeoInfo geo_info = 5;</code>
   */
  google.events.firebase.analytics.v1.GeoInfoOrBuilder getGeoInfoOrBuilder();
   ...
   * @return The appInfo.
   */
  google.events.firebase.analytics.v1.AppInfo getAppInfo();
  /**
   * <pre>
   * App information.
   * </pre>
   ...
   * <code>.google.events.firebase.analytics.v1.AppInfo app_info = 6;</code>
   */
  google.events.firebase.analytics.v1.AppInfoOrBuilder getAppInfoOrBuilder();
   ...
   */
  google.events.firebase.analytics.v1.TrafficSource getTrafficSource();
  /**
   * <pre>
   * Information about marketing campaign which acquired the user.
   * </pre>
   ...
   * <code>.google.events.firebase.analytics.v1.TrafficSource traffic_source = 7;</code>
   */
  google.events.firebase.analytics.v1.TrafficSourceOrBuilder getTrafficSourceOrBuilder();
   ...
   */
  google.events.firebase.analytics.v1.ExportBundleInfo getBundleInfo();
  /**
   * <pre>
   * Information regarding the bundle in which these events were uploaded.
   * </pre>
   ...
   * <code>.google.events.firebase.analytics.v1.ExportBundleInfo bundle_info = 8;</code>
   */
  google.events.firebase.analytics.v1.ExportBundleInfoOrBuilder getBundleInfoOrBuilder();
   ...
   * @return The ltvInfo.
   */
  google.events.firebase.analytics.v1.LtvInfo getLtvInfo();
  /**
   * <pre>
   * Lifetime Value information about this user.
   * </pre>
   ...
   * <code>.google.events.firebase.analytics.v1.LtvInfo ltv_info = 9;</code>
   */
  google.events.firebase.analytics.v1.LtvInfoOrBuilder getLtvInfoOrBuilder();
}
