...
public interface AuthEventDataOrBuilder extends
   ...
   * @return The metadata.
   */
  google.events.firebase.auth.v1.UserMetadata getMetadata();
  /**
   * <pre>
   * Additional metadata about the user.
   * </pre>
   ...
   * <code>.google.events.firebase.auth.v1.UserMetadata metadata = 7;</code>
   */
  google.events.firebase.auth.v1.UserMetadataOrBuilder getMetadataOrBuilder();
   ...
   */
  java.util.List<google.events.firebase.auth.v1.UserInfo> 
      getProviderDataList();
  /**
   * <pre>
   * User's info at the providers
   ...
   * <code>repeated .google.events.firebase.auth.v1.UserInfo provider_data = 8;</code>
   */
  google.events.firebase.auth.v1.UserInfo getProviderData(int index);
  /**
   * <pre>
   * User's info at the providers
   * </pre>
   ...
   * <code>repeated .google.events.firebase.auth.v1.UserInfo provider_data = 8;</code>
   */
  java.util.List<? extends google.events.firebase.auth.v1.UserInfoOrBuilder> 
   ...
   * <code>repeated .google.events.firebase.auth.v1.UserInfo provider_data = 8;</code>
   */
  google.events.firebase.auth.v1.UserInfoOrBuilder getProviderDataOrBuilder(
      int index);
