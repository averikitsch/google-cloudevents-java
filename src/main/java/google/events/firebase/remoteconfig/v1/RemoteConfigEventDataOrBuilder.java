...
public interface RemoteConfigEventDataOrBuilder extends
   ...
   */
  google.events.firebase.remoteconfig.v1.RemoteConfigUser getUpdateUser();
  /**
   * <pre>
   *  Aggregation of all metadata fields about the account that performed the
   *  update.
   ...
   * <code>.google.events.firebase.remoteconfig.v1.RemoteConfigUser update_user = 3;</code>
   */
  google.events.firebase.remoteconfig.v1.RemoteConfigUserOrBuilder getUpdateUserOrBuilder();
   ...
   */
  google.events.firebase.remoteconfig.v1.RemoteConfigUpdateOrigin getUpdateOrigin();
   ...
   */
  google.events.firebase.remoteconfig.v1.RemoteConfigUpdateType getUpdateType();
