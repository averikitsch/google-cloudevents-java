...
public  final class RequestMetadata extends
   ...
   */
  private void setCallerNetworkBytes(
      com.google.protobuf.ByteString value) {
    checkByteStringIsUtf8(value);
   ...
   * <code>.google.rpc.context.AttributeContext.Request request_attributes = 7;</code>
   */
  private void clearRequestAttributes() {  requestAttributes_ = null;
   ...
   * <code>.google.rpc.context.AttributeContext.Peer destination_attributes = 8;</code>
   */
  private void clearDestinationAttributes() {  destinationAttributes_ = null;
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        google.events.cloud.audit.v1.RequestMetadata, Builder> implements
     ...
     * <code>.google.rpc.context.AttributeContext.Request request_attributes = 7;</code>
     */
    public Builder clearRequestAttributes() {  copyOnWrite();
     ...
     * <code>.google.rpc.context.AttributeContext.Peer destination_attributes = 8;</code>
     */
    public Builder clearDestinationAttributes() {  copyOnWrite();
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new google.events.cloud.audit.v1.RequestMetadata();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<google.events.cloud.audit.v1.RequestMetadata> parser = PARSER;
        if (parser == null) {
          synchronized (google.events.cloud.audit.v1.RequestMetadata.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<google.events.cloud.audit.v1.RequestMetadata>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
