...
public interface EventDimensionsOrBuilder extends
  ...
  java.util.Map<java.lang.String, google.events.firebase.analytics.v1.AnalyticsValue>
  getParams();
  /**
   * <pre>
   * A repeated record of the parameters associated with this event.
  ...
  /* nullable */
google.events.firebase.analytics.v1.AnalyticsValue getParamsOrDefault(
      java.lang.String key,
      /* nullable */
google.events.firebase.analytics.v1.AnalyticsValue defaultValue);
  ...
  google.events.firebase.analytics.v1.AnalyticsValue getParamsOrThrow(
      java.lang.String key);
