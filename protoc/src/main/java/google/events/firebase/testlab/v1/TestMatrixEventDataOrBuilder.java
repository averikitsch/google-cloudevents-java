...
public interface TestMatrixEventDataOrBuilder extends
   ...
   * @return The state.
   */
  google.events.firebase.testlab.v1.TestState getState();
   ...
   */
  google.events.firebase.testlab.v1.OutcomeSummary getOutcomeSummary();
   ...
   */
  google.events.firebase.testlab.v1.ResultStorage getResultStorage();
  /**
   * <pre>
   * Locations where test results are stored.
   * </pre>
   ...
   * <code>.google.events.firebase.testlab.v1.ResultStorage result_storage = 5;</code>
   */
  google.events.firebase.testlab.v1.ResultStorageOrBuilder getResultStorageOrBuilder();
   ...
   */
  google.events.firebase.testlab.v1.ClientInfo getClientInfo();
  /**
   * <pre>
   * Information provided by the client that created the test matrix.
   * </pre>
   ...
   * <code>.google.events.firebase.testlab.v1.ClientInfo client_info = 6;</code>
   */
  google.events.firebase.testlab.v1.ClientInfoOrBuilder getClientInfoOrBuilder();
