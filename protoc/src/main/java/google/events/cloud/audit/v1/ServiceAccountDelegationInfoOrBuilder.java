...
public interface ServiceAccountDelegationInfoOrBuilder extends
   ...
   */
  google.events.cloud.audit.v1.ServiceAccountDelegationInfo.FirstPartyPrincipal getFirstPartyPrincipal();
  /**
   * <pre>
   * First party (Google) identity as the real authority.
   * </pre>
   ...
   * <code>.google.events.cloud.audit.v1.ServiceAccountDelegationInfo.FirstPartyPrincipal first_party_principal = 1;</code>
   */
  google.events.cloud.audit.v1.ServiceAccountDelegationInfo.FirstPartyPrincipalOrBuilder getFirstPartyPrincipalOrBuilder();
   ...
   */
  google.events.cloud.audit.v1.ServiceAccountDelegationInfo.ThirdPartyPrincipal getThirdPartyPrincipal();
  /**
   * <pre>
   * Third party identity as the real authority.
   * </pre>
   ...
   * <code>.google.events.cloud.audit.v1.ServiceAccountDelegationInfo.ThirdPartyPrincipal third_party_principal = 2;</code>
   */
  google.events.cloud.audit.v1.ServiceAccountDelegationInfo.ThirdPartyPrincipalOrBuilder getThirdPartyPrincipalOrBuilder();

  public google.events.cloud.audit.v1.ServiceAccountDelegationInfo.AuthorityCase getAuthorityCase();
}
