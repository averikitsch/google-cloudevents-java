...
public interface ArtifactsOrBuilder extends
   ...
   * @return The objects.
   */
  google.events.cloud.cloudbuild.v1.Artifacts.ArtifactObjects getObjects();
  /**
   * <pre>
   * A list of objects to be uploaded to Cloud Storage upon successful
   * completion of all build steps.
   ...
   * <code>.google.events.cloud.cloudbuild.v1.Artifacts.ArtifactObjects objects = 2;</code>
   */
  google.events.cloud.cloudbuild.v1.Artifacts.ArtifactObjectsOrBuilder getObjectsOrBuilder();
}
