...
public interface BuildOptionsOrBuilder extends
   ...
   */
  java.util.List<google.events.cloud.cloudbuild.v1.Hash.HashType> getSourceProvenanceHashList();
  /**
   * <pre>
   * Requested hash for SourceProvenance.
   * </pre>
   ...
   */
  google.events.cloud.cloudbuild.v1.Hash.HashType getSourceProvenanceHash(int index);
  /**
   * <pre>
   * Requested hash for SourceProvenance.
   * </pre>
   ...
   */
  google.events.cloud.cloudbuild.v1.BuildOptions.VerifyOption getRequestedVerifyOption();
   ...
   */
  google.events.cloud.cloudbuild.v1.BuildOptions.MachineType getMachineType();
   ...
   */
  google.events.cloud.cloudbuild.v1.BuildOptions.SubstitutionOption getSubstitutionOption();
   ...
   */
  google.events.cloud.cloudbuild.v1.BuildOptions.LogStreamingOption getLogStreamingOption();
   ...
   * @return The logging.
   */
  google.events.cloud.cloudbuild.v1.BuildOptions.LoggingMode getLogging();
   ...
   * <code>repeated .google.events.cloud.cloudbuild.v1.Volume volumes = 14;</code>
   */
  java.util.List<? extends google.events.cloud.cloudbuild.v1.VolumeOrBuilder> 
   ...
   * <code>repeated .google.events.cloud.cloudbuild.v1.Volume volumes = 14;</code>
   */
  google.events.cloud.cloudbuild.v1.VolumeOrBuilder getVolumesOrBuilder(
      int index);
}
