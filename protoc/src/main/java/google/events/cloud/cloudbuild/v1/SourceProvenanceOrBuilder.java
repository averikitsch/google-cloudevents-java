...
public interface SourceProvenanceOrBuilder extends
   ...
   */
  google.events.cloud.cloudbuild.v1.StorageSource getResolvedStorageSource();
  /**
   * <pre>
   * A copy of the build's `source.storage_source`, if exists, with any
   * generations resolved.
   ...
   * <code>.google.events.cloud.cloudbuild.v1.StorageSource resolved_storage_source = 3;</code>
   */
  google.events.cloud.cloudbuild.v1.StorageSourceOrBuilder getResolvedStorageSourceOrBuilder();
   ...
   */
  google.events.cloud.cloudbuild.v1.RepoSource getResolvedRepoSource();
  /**
   * <pre>
   * A copy of the build's `source.repo_source`, if exists, with any
   * revisions resolved.
   ...
   * <code>.google.events.cloud.cloudbuild.v1.RepoSource resolved_repo_source = 6;</code>
   */
  google.events.cloud.cloudbuild.v1.RepoSourceOrBuilder getResolvedRepoSourceOrBuilder();
  ...
  java.util.Map<java.lang.String, google.events.cloud.cloudbuild.v1.FileHashes>
  getFileHashes();
  /**
   * <pre>
   * Hash(es) of the build source, which can be used to verify that
  ...
  /* nullable */
google.events.cloud.cloudbuild.v1.FileHashes getFileHashesOrDefault(
      java.lang.String key,
      /* nullable */
google.events.cloud.cloudbuild.v1.FileHashes defaultValue);
  ...
  google.events.cloud.cloudbuild.v1.FileHashes getFileHashesOrThrow(
      java.lang.String key);
}
